...
$wp_customize->add_setting( 'biography-options[biography-home-history-page-4]', array(
    'capability'		=> 'edit_theme_options',
    'default'			=> $biography_customizer_defaults['biography-home-history-page-4'],
    'sanitize_callback' => 'biography_sanitize_post'
) );

$wp_customize->add_control( 'biography-options[biography-home-history-page-4]', array(
    'label'                 =>  esc_html__( 'Select Page For History 4', 'biography' ),
    'section'               => 'biography-home-history-pages',
    'type'                  => 'dropdown-pages',
    'priority'              => 80,
    'settings' => 'biography-options[biography-home-history-page-4]',
) );
$wp_customize->add_setting( 'biography-options[biography-home-history-duration-4]', array(
    'capability'		=> 'edit_theme_options',
    'default'			=> $biography_customizer_defaults['biography-home-history-duration-4'],
    'sanitize_callback' => 'sanitize_text_field'
) );

$wp_customize->add_control( 'biography-options[biography-home-history-duration-4]', array(
    'settings' => 'biography-options[biography-home-history-duration-4]',
    'label'                 =>  esc_html__( 'Duration For History 4', 'biography' ),
    'section'               => 'biography-home-history-pages',
    'type'                  => 'text',
    'priority'              => 90
) );
$wp_customize->add_setting( 'biography-options[biography-home-history-icon-4]', array(
    'capability'		=> 'edit_theme_options',
    'default'			=> $biography_customizer_defaults['biography-home-history-icon-4'],
    'sanitize_callback' => 'sanitize_text_field'
) );

$wp_customize->add_control( 'biography-options[biography-home-history-icon-4]', array(
    'label'                 =>  esc_html__( 'Icon For History 4', 'biography' ),
    'description'           => sprintf( esc_html__( 'Use font awesome icon: Eg: %1$s. %2$sSee more here%3$s', 'biography' ), 'fa-rocket','<a href="'.esc_url('http://fontawesome.io/icons/').'" target="_blank">','</a>' ),
    'section'               => 'biography-home-history-pages',
    'type'                  => 'text',
    'priority'              => 95,
    'settings' => 'biography-options[biography-home-history-icon-4]',
) );
