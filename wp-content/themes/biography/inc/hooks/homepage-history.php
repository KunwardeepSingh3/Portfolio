...
if ( ! function_exists( 'biography_home_history_array' ) ) :
    ...
    function biography_home_history_array(  ){
		...
		$biography_home_history_contents_array[3]['biography-home-history-duration'] = esc_html__('2014-current', 'biography');
        $biography_home_history_contents_array[3]['biography-home-history-title'] = esc_html__('Customer Support', 'biography');
        $biography_home_history_contents_array[3]['biography-home-history-content'] = esc_html__("Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.", 'biography');
        $biography_home_history_contents_array[3]['biography-home-history-link'] = '#';
        $biography_home_history_contents_array[3]['biography-home-history-icon'] = 'fa-rocket';
		...
		$biography_home_history_posts[3]['biography-home-history-pages-ids'] = $biography_customizer_saved_options['biography-home-history-page-4'];
		...
		$biography_home_history_posts[3]['biography-home-history-page-icon'] = $biography_customizer_saved_options['biography-home-history-icon-4'];
		...
		$biography_home_history_posts[3]['biography-home-history-duration'] = $biography_customizer_saved_options['biography-home-history-duration-4'];
        ...
        if( !empty( $biography_home_history_args )){
            ...
            if ( $biography_home_history_post_query->have_posts() ) :
                ...
                while ( $biography_home_history_post_query->have_posts() ) : $biography_home_history_post_query->the_post();
                    ...
                    $biography_home_history_contents_array[$i]['biography-home-history-content'] = biography_words_count( 9 ,get_the_content());
