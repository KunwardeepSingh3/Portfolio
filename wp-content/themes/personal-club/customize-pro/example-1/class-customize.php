 ...
 * @access public
 */
final class personal_club_Example_1_Customize {
	...
	public function personal_club_sections( $manager ) {
		...
		$manager->register_section_type( 'personal_club_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new personal_club_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
					'title'    => esc_html__( 'Upgrade to Pro', 'personal-club' ),
					'pro_text' => esc_html__( 'Upgrade Now', 'personal-club' ),
					'pro_url'  => personal_club_PROTHEME_URL,
					'priority'   => 1,
				)
			)
		);
...
personal_club_Example_1_Customize::personal_club_get_instance();